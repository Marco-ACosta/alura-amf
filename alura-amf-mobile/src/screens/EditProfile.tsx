    ...
    return (
        <Auth>
            <Screen>
                ...
                <TextInput style={styles.info} placeholder="Nome" value={name} onChangeText={setName}/>

                <Text> Sobrenome: </Text>
                <TextInput style={styles.info} placeholder="Sobrenome"  value={lastName} onChangeText={setLastName}/> 

                <Text> Telefone </Text>
                <TextInput style={styles.info} placeholder="Telefone" value={phone} onChangeText={setPhone} />
